...
export function getSystemBadgeColor(id: string): string {
  ...
  const colorMap: Record<string, string> = {
    ...
    xbox: 'bg-[#107C10] border-green-500 text-white hover:shadow-[0_0_12px_rgba(16,124,16,0.35)]',
    xboxclassic: 'bg-[#107C10] border-green-500 text-white hover:shadow-[0_0_12px_rgba(16,124,16,0.35)]',
    xbox360: 'bg-[#107C10] border-emerald-400 text-white hover:shadow-[0_0_12px_rgba(16,124,16,0.35)]',
